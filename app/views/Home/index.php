                ...
                <div class="card-body p-4">
                    ...
                    <?php else : ?>
                        ...
                        <p class="text-muted mb-2">
                            Komoditas: <?= $data['asn'][0]['daftar_komoditas']; ?> 
                            <span class="badge bg-info text-dark ms-1"><?= $data['asn'][0]['jumlah_jenis']; ?> Jenis</span>
                        </p>
                        <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-medium text-dark">
                                            ...
                                            <?php if($asn['jumlah_jenis'] > 1): ?>
                                                <br><span class="badge bg-light text-secondary border mt-1"><?= $asn['jumlah_jenis']; ?> Item</span>
                                            <?php endif; ?>
                                        </td>
                                        
                                        <td><strong class="text-success"><?= number_format($asn['total_berat'], 2, ',', '.'); ?> Kg</strong></td>
